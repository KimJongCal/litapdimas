                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Data Tabel Master Satker</h3>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="bidangilmu" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($tbMasterSatker as $value): ?>
                                        <?php
                                            if($value->status=="1"){
                                                $stat = "TRUE";
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group" aria-label="Action">
                                                    <a href="<?=base_url('index.php/Admin/Master/Satker/Edit/'.$value->id_satker)?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="<?=base_url('index.php/Admin/Master/Satker/Delete/'.$value->id_satker)?>" onclick="return confirm('Apakah Anda Yakin ?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $no++; endforeach ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?=form_open_multipart('Admin/Master/Satker/Add/')?>
