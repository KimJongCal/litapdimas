        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        Master
                        <small><i>Jabatan Fungsional</i></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-gears"></i> Master</a></li>
                        <li class="active"><i>Jabatan Fungsional</i></li>
                    </ol>
                </section>
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Data Tabel Master Jabatan Fungsional</h3>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="bidangilmu" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($tbMasterJabatanFungsional as $value): ?>
                                        <?php
                                            if($value->status=="1"){
                                                $stat = "TRUE";
                                        ...
                                        <tr>
                                            <td><?=$no++?></td>
                                            <td><?=$value->id_jab_fungsional?></td>
                                            <td><?=$value->jab_fungsional?></td>
                                            <td><?=$stat?></td>
                                            <td class="text-center">
                                                <div class="btn-group" role="group" aria-label="Action">
                                                    <a href="<?=base_url('index.php/Admin/Master/JabatanFungsional/Edit/'.$value->id_jab_fungsional)?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="<?=base_url('index.php/Admin/Master/JabatanFungsional/Delete/'.$value->id_jab_fungsional)?>" onclick="return confirm('Apakah Anda Yakin ?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $no++; endforeach ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?=form_open_multipart('Admin/Master/JabatanFungsional/Add/')?>
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Jabatan Fungsional :</label>
                        <input type="text" name="jab_fungsional" class="form-control" placeholder="Jabatan Fungsional" required="">
                    </div>
                    <div class="form-group">
