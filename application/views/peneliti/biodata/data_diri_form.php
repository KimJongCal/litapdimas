                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="row">
                                        <div class="col-md-12 col-md-offset-7 col-sm-5 col-xs-12 profile-badge">
                                ...
                                <div class="col-md-7 col-md-offset-2 col-sm-5 col-xs-12">
                                    ...
                                    <br>
                                    <form method="POST" action="<?=base_url('index.php/Peneliti/Biodata/EditDatadiri/'.$this->session->userdata('id_peneliti'))?>" class="form-horizontal">
                                        <div class="form-group">
                                            <label for="fungsional" class="col-sm-3 control-label">Fungsional</label>
                                            <div class="col-sm-9">
                                              <select name="fungsional" class="form-control" disabled="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="nidn" class="form-control" id="nidn" placeholder="NIDN" value="<?=$tbPeneliti->nidn?>" readonly="">
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" name="nip" class="form-control" id="nip" placeholder="NIP" value="<?=$tbPeneliti->nip?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?=$tbPeneliti->nama?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Tempat/Tgl Lahir</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="tempat" class="form-control" placeholder="tempat" value="<?=$tbPeneliti->tempat?>" readonly="">
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="date" name="tgl_lhr" class="form-control" placeholder="" value="<?=$tbPeneliti->tgl_lhr?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Alamat</label>
                                            <div class="col-sm-9">
                                                <textarea name="alamat" class="form-control" readonly=""><?=$tbPeneliti->alamat?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="jabatan" class="form-control" placeholder="jabatan" value="<?=$tbPeneliti->jabatan?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Pangkat/Gol</label>
                                            <div class="col-sm-3">
                                                <select name="gol" class="form-control" disabled="">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="jabfung" class="form-control" disabled="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="email" name="email" class="form-control" placeholder="email" value="<?=$tbPeneliti->email?>" readonly="">
                                            </div>
                                            <label class="col-sm-3 control-label">No. HP</label>
                                            <div class="col-sm-3">
                                                <input type="number" name="no hp" class="form-control" placeholder="no hp" value="<?=$tbPeneliti->hp?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="bidang_ilmu" class="col-sm-3 control-label">Bidang Ilmu</label>
                                            <div class="col-sm-9">
                                              <select name="bidang_ilmu" class="form-control" disabled="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="pull-right">
                                                    <button type="submit" class="btn btn-warning btn-block btn-flat"><span class="glyphicon glyphicon-edit"></span> Ubah Biodata Diri</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
