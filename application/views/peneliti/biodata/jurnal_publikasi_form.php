                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-md-offset-2 col-sm-6 col-xs-12">
                                    <ul class="nav nav-tabs nav-justified">
                                      ...
                                      <li role="presentation" class="active"><a href="<?=base_url('index.php/Peneliti/Biodata/JurnalPublikasi')?>">Jurnal/Publikasi</a></li>
                                      <li role="presentation"><a href="<?=base_url('index.php/Peneliti/Biodata/Buku')?>">Buku</a></li>
                                    </ul>
                                    <center><h3>Jurnal / Publikasi</h3></center>
                                    <br>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <?php $no=1; foreach($tbPenelitiJurnal as $value): ?>
                                                <tr>
                                                    ...
                                                    <td><?=$value->url?></td>
                                                    <td>
                                                        <a class="btn btn-danger" href="<?=base_url('index.php/Peneliti/Biodata/HapusJurnal/'.$value->id_peneliti_jurnal)?>" onclick="return confirm('Yakin hapus?')"><span class="glyphicon glyphicon-remove"></span> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <?php endif; ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="<?=base_url('index.php/Peneliti/Biodata/TambahJurnal')?>" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Judul Jurnal</label>
                        <div class="col-sm-10">
                            <input type="text" name="judul" class="form-control" placeholder="Judul Jurnal">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nama Jurnal</label>
                        <div class="col-sm-10">
                            <input type="text" name="nama" class="form-control" placeholder="Nama Jurnal">
                        </div>
                    </div>
                    <div class="form-group">
