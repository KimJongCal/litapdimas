                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-md-offset-2 col-sm-6 col-xs-12">
                                    <ul class="nav nav-tabs nav-justified">
                                      ...
                                      <li role="presentation" class="active"><a href="<?=base_url('index.php/Peneliti/Biodata/Pendidikan')?>">Pendidikan</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <?php if(!empty($tbPenelitiPendidikan)): ?>
                                            <?php $no=1; foreach($tbPenelitiPendidikan as $value): ?>
                                                <tr>
                                                    ...
                                                    <td><?=$value->tahun?></td>
                                                    <td>
                                                        <a class="btn btn-danger" href="<?=base_url('index.php/Peneliti/Biodata/HapusPendidikan/'.$value->id_peneliti_pendidikan)?>" onclick="return confirm('Yakin hapus?')"><span class="glyphicon glyphicon-remove"></span> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <?php endif; ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Tambah Riwayat Pendidikan</h4>
              </div>
              <div class="modal-body">
                <form method="POST" action="<?=base_url('index.php/Peneliti/Biodata/TambahPendidikan')?>" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nama PT</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">File Izajah</label>
                        <div class="col-sm-10">
