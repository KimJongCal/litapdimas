                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body" role="navigation">
                            ...
                            <form method="POST" action="<?=base_url('index.php/Peneliti/Pengajuan/UpdateRegistrasi/'.$tbProposal->id_proposal)?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Kluster</label>
                                            <select name="kluster" class="form-control select2" style="width: 100%;" required="">
                                                <option selected="selected">Pilih Kluster</option>
                                                <?php foreach($tbMKluster as $value): ?>
                                                    <option value="<?=$value->id_kluster?>" <?php if($value->id_kluster==$tbProposal->id_kluster){ echo "selected"; }?>><?=$value->kluster?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="bidang_ilmu" class="form-control select2" style="width: 100%;" required="">
                                                <option selected="selected">Pilih Bidang Ilmu</option>
                                                <?php foreach($tbMBidangIlmu as $value): ?>
                                                    <option value="<?=$value->id_bidang_ilmu?>" <?php if($value->id_bidang_ilmu==$tbProposal->id_bidang_ilmu){ echo "selected"; }?>><?=$value->bidang_ilmu?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
